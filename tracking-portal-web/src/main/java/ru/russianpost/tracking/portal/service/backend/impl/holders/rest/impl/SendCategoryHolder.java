...
/**
 * @author Amosov Maxim
 * @since 21.04.2021 : 17:07
 */
@Component
public class SendCategoryHolder extends LocalizedHolder {
    /**
     * @param holderConfig rest holder config
     */
    public SendCategoryHolder(final RestHolderConfig holderConfig) {
        super(buildDictionaryUri(holderConfig.getDictionaryUrl(), "sendCategories"), holderConfig.getRestTemplate());
    }
}
