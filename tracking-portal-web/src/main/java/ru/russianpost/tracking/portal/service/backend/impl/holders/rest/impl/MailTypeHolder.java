 ...
 */
@Component
public class MailTypeHolder extends LocalizedHolder {
    /**
     * @param holderConfig rest holder config
     */
    public MailTypeHolder(final RestHolderConfig holderConfig) {
        super(buildDictionaryUri(holderConfig.getDictionaryUrl(), "mailTypes"), holderConfig.getRestTemplate());
    }
}
