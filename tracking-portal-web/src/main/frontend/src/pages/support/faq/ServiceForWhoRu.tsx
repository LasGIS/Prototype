  ...
  <div className="help-page">
    <div className="help-article">
      ...
      <article className="page-help-article__content">
        <p>
          API предназначен для интернет-магазинов и крупных отправителей, которым необходимо отслеживать&nbsp;отправления&nbsp;и использовать эту
          информацию в своих информационных системах.
        </p>
        <p>&nbsp;</p>
        <p>
          Если вам нужно просто отследить одну или несколько посылок, воспользуйтесь <a href="http://pochta.ru">основным порталом</a>&nbsp;или
