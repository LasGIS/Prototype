    ...
    <div className="help-article">
      <div>
        <header>
          <h1>Support</h1>
          <p>
            If you do not find the answer to your question - please contact support by phone Russian Post <b>8-800-100-00-00</b> or email at&nbsp;
        ...
        <footer>
          ...
          <h2>
            <b>8-800-100-00-00</b> or <a href="mailto:client@russianpost.ru">client@russianpost.ru</a>
          </h2>
        </footer>
      </div>
    </div>
