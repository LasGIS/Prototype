...
export const ArticleContentEn = () => (
  <>
    ...
    <p>
      ...
      as Service), Internet site: <Link to="/">https://tracking.pochta.ru/</Link> on the conditions stated in this User Agreement (hereinafter refered
      to as «Agreement»).
    ...
    <p>
      ...
      <br /> User agreement as in present in force is always available here:
    ...
    <p>
      ...
      logout from his account on the site <Link to="/">https://tracking.pochta.ru</Link> at the end of each session (using &quot;Exit&quot; button).
      The company is not responsible for loss or damage of data, as well as other consequences of any nature that may occur due to violations of the
      conditions of this part of the User Agreement.
    </p>
    <p>&nbsp;</p>
    <p>
    ...
    <p>
      ...
      to 3000 of tracking numbers) according to specifications:
