...
export const BatchEn = () =>
  <div className="my-tracking-page__content">
    <header>
      ...
      <p>Remote Batch Access allows to track several shipments at once in one query. Each query may contain up to 3000 tracking numbers.
        Underlying protocol of remote batch access: SOAP (Simple Object Access Protocol).</p>

      <p>The work with API of shipments tracking service is carried out in two phases:<br/>
        1) To request for the information the user should enter ticket query, which contains the list of tracking numbers of the shipments.(call
        of method getTicket);<br/>
        2) To receive the response to the ticket (call of method getResponseByTicket).</p>

      <p>The method returns information about all the operations done with every shipment. Information on each operation consists of the following
        elements: time and place of the operation, code and attribute of the operation, name of the operation.</p>
      ...
      <table className='table_500'>
        ...
        <tr>
          ...
          <td><span className='arial-dark'>SOAP 1.1</span>
          </td>
        </tr>
        <tr>
      ...
      <p>- It is advisable to request for the first response according to the ticket not earlier than 15 minutes since the issue of the ticket. If
        the result is not ready, further requests should be done not more than once in 15 minutes.</p>

      <p>- Storage period of the response according to ticket in tracking Service is 32 hours. Once this period expires the response is
        deleted.</p>

      <h4>3. Method getTicket</h4>

      <p>Method getTicket is used to receive the ticket to the information according to the list of tracking numbers. The request contains the
        list
        of tracking numbers. Upon successful completion, the method returns ticket identifier.</p>
      ...
      <table>
        ...
        <tr>
          ...
          <td style={{ width: "126px", height: "27px" }}>&nbsp;</td>
          <td style={{ width: "351px", height: "27px" }}>
            <p>Login for the access to API of tracking service. One may obtain it in <Link to="/access-settings">«Access
      ...
      <table className='table-100'>
        ...
        <tr>
          ...
          <td style={{ width: "60.64%", height: "27px" }}>
            <p style={{ textAlign: "left" }}>The identifier of issued ticket. It contains the data on the date and time of ticket issue and the user who has
              sent the request. The format:</p>

            <p style={{ textAlign: "left" }}><strong>YYYYMMDDHHmmsslllNAME</strong>, where</p>
      ...
      <table className='table-100'>
        ...
        <tr>
          ...
          <td style={{ width: "18.46%", height: "27px" }}>&nbsp;</td>
          <td style={{ width: "54.94%", height: "27px" }}>
            <p>Contains information on single registered shipment tracking number. Number of the elements of type «Item» in the response
              corresponds to the number of tracking numbers listed in the query get Ticket earlier.</p>
          </td>
        </tr>
        <tr>
          <td style={{ width: "18.46%", height: "27px" }}>
        ...
        <tr>
          ...
          <td style={{ width: "18.46%", height: "27px" }}>&nbsp;</td>
          <td style={{ width: "54.94%", height: "27px" }}>
            <p>Contains information on single operation in tracking history of the registered shipment. The number of the elements of the
              type
              «Operation» corresponds to the number of the registered operations in tracking history of the registered shipment.</p>
          </td>
        </tr>
        <tr>
          <td style={{ width: "18.46%", height: "27px" }}>
          ...
          <td style={{ width: "54.94%", height: "27px" }}>
            <p><Link to="/support/dictionaries/operation_codes">Operation code.</Link></p>
          </td>
        </tr>
        <tr>
          <td style={{ width: "18.46%", height: "27px" }}>
          ...
          <td style={{ width: "54.94%", height: "27px" }}>
            <p><Link to="/support/dictionaries/operation_codes">Attribute code.</Link></p>
          </td>
        </tr>
        <tr>
          <td style={{ width: "18.46%", height: "27px" }}>
          ...
          <td style={{ width: "54.94%", height: "27px" }}>
            <p><Link to="/support/dictionaries/operation_codes">Operation name.</Link></p>
          </td>
        </tr>
        <tr>
          <td style={{ width: "18.46%", height: "27px" }}>
