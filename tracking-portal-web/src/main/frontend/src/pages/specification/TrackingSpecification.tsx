      ...
      <div>
        <div className="specification-page row-fluid">
          <ul className="span1 nav nav-list specification-page__left-menu tracking-left-menu">
            <li className={modeClass('single')} role="presentation" tabIndex={-1} onClick={() => this.setMode('single')}>
              <span>{t('stat.left-menu.text-single-link')}</span>
            </li>
            <li className={modeClass('batch')} role="presentation" tabIndex={-1} onClick={() => this.setMode('batch')}>
