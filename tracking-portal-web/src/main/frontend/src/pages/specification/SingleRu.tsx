...
const SingleRu = () => (
  <div className="my-tracking-page__content">
    <header>
      ...
      <p>
        Режим Единичного доступа позволяет за одно обращение к Сервису отслеживания&nbsp;получить информацию по одному регистрируемому почтовому
        отправлению (РПО). Возможны следующие запросы:
      </p>

      <ul>
        <li>
          получение подробной информации обо всех операциях, совершенных над отправлением (метод&nbsp;
          <Link to="#getOperationHistory">getOperationHistory</Link>). Информация об одной операции включает время и место проведения операции, код и
          атрибут операции, название операции и другие поля;
        </li>
        <li>
          получение информации об операциях с наложенным платежом, который связан с отправлением (метод&nbsp;
          ...
          <tr>
            ...
            <td>
              <span className="arial-dark">
                <Link to="#getOperationHistory">getOperationHistory</Link> возвращает историю операций над отправлением
                <br />
                <Link dir="ltr" to="#PostalOrderEventsForMail">
                  PostalOrderEventsForMail
                </Link>{' '}
                возвращает историю операций с наложенным платежом
              </span>
            </td>
          </tr>
          <tr>
      ...
      <p>
        Метод getOperationHistory используется для получения&nbsp;информации о конкретном отправлении. Метод возвращает подробную информацию по всем
        операциям, совершенным над отправлением.
      </p>
      ...
      <table className="table-100">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <p>
                Логин для доступа к API Сервиса отслеживания. Может быть получен в разделе&nbsp;
          ...
          <tr>
            ...
            <td>
              <p>
                Пароль для доступа к API Сервиса отслеживания. Может быть получен в разделе&nbsp;
                <Link to="/access-settings">Настройки доступа</Link>.
              </p>
            </td>
            <td>
      ...
      <p>
        Ответ метода getOperationHistory содержит список элементов historyRecord. Каждый из них содержит информацию об одной операции над
        отправлением. Если над отправлением еще не зарегистрировано ни одной операции, то возвращается пустой список элементов historyRecord.
      </p>
      ...
      <p>
        ...
        <br />- Операция (OperType) и ее атрибут (OperAttr).
      </p>
      ...
      <table className="table-100">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                Код страны. Возможные коды приведены в поле &quot;Код&quot; <Link to="/support/dictionaries/countries">справочника стран.</Link>
              </p>
            </td>
          </tr>
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                Двухбуквенный идентификатор страны. Возможные идентификаторы приведены в поле &quot;Alpha2 код&quot;&nbsp;
          ...
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                Трехбуквенный идентификатор страны. Возможные идентификаторы приведены в поле &quot;Alpha3 код&quot;&nbsp;
                <Link to="/support/dictionaries/countries">справочника стран.</Link>
              </p>
            </td>
          </tr>
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                Российское название страны. Возможные названия приведены в поле &quot;Наименование страны пересылки&quot;&nbsp;
                <Link to="/support/dictionaries/countries">справочника стран.</Link>
              </p>
            </td>
          </tr>
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                Международное название страны. Возможные названия приведены в поле «Английское наименование страны пересылки»&nbsp;
                <Link to="/support/dictionaries/countries">справочника стран.</Link>
              </p>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                Служебная&nbsp;информация, идентифицирующая&nbsp;отправление, может иметь значение ДМ квитанции, связанной с отправлением или иметь
                значение &lt;null&gt;
              </p>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                Содержит информацию о <Link to="/support/dictionaries/mailrank">разряде почтового отправления.</Link>
              </p>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                Содержит информацию об <Link to="/support/dictionaries/postmark">отметках почтовых отправлений.</Link>
              </p>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                Содержит данные о <Link to="/support/dictionaries/mailtype">виде почтового отправления.</Link>
              </p>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                Содержит данные о <Link to="/support/dictionaries/category_codes">категории почтового отправления.</Link>
              </p>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                Содержит информацию об <Link to="/support/dictionaries/operation_codes">операции над отправлением.</Link>
              </p>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                Содержит информацию об <Link to="/support/dictionaries/operation_codes">атрибуте операции над отправлением.</Link>
              </p>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                Содержит информацию о <Link to="/support/dictionaries/send_ctg">категории отправителя.</Link>
              </p>
            </td>
          </tr>
          <tr>
      ...
      <p>
        Метод PostalOrderEventsForMail позволяет получить информацию об операциях с наложенным платежом, который связан с конкретным почтовым
        отправлением.
      </p>
      ...
      <table className="table-100">
        ...
        <tbody>
          ...
          <tr>
            <td>EventDateTime</td>
            <td>
              Дата и время операции в формате YYYY-MM-DDTHH:mm:ss.SSSZ
              <br />
          ...
          <tr>
            <td>EventType</td>
            <td>
              <Link to="/support/dictionaries/event_type">Код операции с наложенным платежом</Link>
            </td>
          </tr>
          <tr>
            <td>EventName</td>
            <td>
              <Link to="/support/dictionaries/event_type">Название операции</Link>
            </td>
          </tr>
          <tr>
            <td>IndexTo</td>
          ...
          <tr>
            ...
            <td>
              Двухбуквенный идентификатор страны, в которой была совершена операция. Возможные идентификаторы приведены в поле &quot;Alpha2
              код&quot;&nbsp;
              <Link to="/support/dictionaries/countries">справочника стран</Link>.
            </td>
          </tr>
          <tr>
            ...
            <td>
              <p>
                Двухбуквенный идентификатор страны получателя наложенного платежа. Возможные идентификаторы приведены в поле &quot;Alpha2
                код&quot;&nbsp;
                <Link to="/support/dictionaries/countries">справочника стран</Link>.
              </p>
            </td>
