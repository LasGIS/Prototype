...
const SingleEn = () => (
  <div className="my-tracking-page__content">
    <header>
      ...
      <p>Single access mode: each query to tracking service gives information on one registered postal item. Possible queries are listed below:</p>

      <ul>
        <li>
          detailed information on all operations during the delivery (method <Link to="#getOperationHistory">getOperationHistory</Link>). Information
          on each operation consists of the time and place of the operation, operation code and operation attribute, the name of the operation and
          other fields;
        </li>
        <li>
          detailed information on the operations on all COD items (method <Link to="#PostalOrderEventsForMail">PostalOrderEventsForMail</Link>).
        </li>
      </ul>
      ...
      <table className="table_500">
        <tbody>
          ...
          <tr>
            ...
            <td>
              <span className="arial-dark">
                <Link to="#getOperationHistory">getOperationHistory</Link>
                returns history of operations during the delivery
                <br />
                <Link dir="ltr" to="#PostalOrderEventsForMail">
          ...
          <tr>
            ...
            <td>
              <span className="arial-dark">SOAP 1.2</span>
            </td>
          </tr>
          <tr>
            <td>
      ...
      <p>
        Method getOperationHistory is used to receive information on specific shipment. Method returns detailed information about all the operations
        during the delivery of the shipment.
      </p>
      ...
      <table className="table-100">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <p>
                Login for the access to API of tracking service could be found in&nbsp;<Link to="/access-settings">«Access settings»</Link>
                section.
              </p>
            </td>
            <td>
          ...
          <tr>
            ...
            <td>
              <p>
                Password for the access to API of tracking service could be found in&nbsp;<Link to="/access-settings">«Access settings»</Link>
                section.
              </p>
            </td>
            <td>
      ...
      <p>
        The response of the method getOperationHistory contains list of elements historyRecord. Each element contains information on single operation
        during the delivery of the shipment. If there is no registered operations yet, the method returns null list.
      </p>

      <p>
        The following information on the operation is mandatory in each response:
        <br />
        - Date of the operation (OperDate);
        <br />
        - Place of the operation (OperationAddress);
        <br />- Operation (OperType) and its attribute (OperAttr).
      </p>
      ...
      <table className="table-100">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                The postcode of the of the place of operation during the delivery of the shipment.. The method doesn&apos;t return it for the
          ...
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                The code of the country. Codes are listed in the field «Code» of <Link to="/support/dictionaries/countries">«Country Directory»</Link>
                .
              </p>
            </td>
          </tr>
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                Two-letter identity code of the country. Identity codes are listed in the field “Alpha2” of{' '}
          ...
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                Three-letter identity code of the country. Identity codes are listed in the field “Alpha3” of{' '}
                <Link to="/support/dictionaries/countries">«Country Directory»</Link>.
              </p>
            </td>
          </tr>
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                Name of the country in Russian language. Identity codes are listed in the field “Country of the point of destination” of{' '}
                <Link to="/support/dictionaries/countries">«Country Directory»</Link>.
              </p>
            </td>
          </tr>
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                Name of the country in English language. Identity codes are listed in the field “Name of the country in English” of{' '}
                <Link to="/support/dictionaries/countries">«Country Directory»</Link>.
              </p>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                Service information on shipment identification. May contain the number of Direct Mail receipt, related to the shipment or &lt;null&gt;
                value.
              </p>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                Contains information on <Link to="/support/dictionaries/mailrank">mail rank</Link>.
              </p>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                Contains information on <Link to="/support/dictionaries/mailtype">mail type</Link>.
              </p>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                Contains information on <Link to="/support/dictionaries/category_codes">mail category</Link>.
              </p>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                Contains information about the <Link to="/support/dictionaries/operation_codes">operation during the delivery</Link>.
              </p>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                Contains information about the <Link to="/support/dictionaries/operation_codes">attribute of the operation during the delivery</Link>.
              </p>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td style={{ width: '54.36%' }}>
              <p>
                Contains information about the <Link to="/support/dictionaries/send_ctg">category of the sender</Link>.
              </p>
            </td>
          </tr>
          <tr>
        ...
        <tbody>
          <tr>
            <td>
              ...
              xmlns:oper=&quot;http://russianpost.org/operationhistory&quot; xmlns:data=&quot;http://russianpost.org/operationhistory/data&quot;
      ...
      <table className="table-100">
        ...
        <tbody>
          ...
          <tr>
            <td>EventDateTime</td>
            <td>
              Date and time of the operation in the format: YYYY-MM-DDTHH:mm:ss.SSSZ
              <br />
          ...
          <tr>
            <td>EventType</td>
            <td>
              <Link to="/support/dictionaries/event_type">Code of the operation with COD</Link>
            </td>
          </tr>
          <tr>
            <td>EventName</td>
            <td>
              <Link to="/support/dictionaries/event_type">Operation name</Link>
            </td>
          </tr>
          <tr>
            <td>IndexTo</td>
          ...
          <tr>
            ...
            <td>
              Two-letter identity code of the country, where the operation was done. Identity codes are listed in the field “Alpha2” of
              <Link to="/support/dictionaries/countries">“Country directory”</Link>.
            </td>
          </tr>
          <tr>
            ...
            <td>
              <p>
                Two-letter identity code of the country of the addressee of COD. Identity codes are listed in the field “Alpha2” of
                <Link to="/support/dictionaries/countries">“Country directory”</Link>.
              </p>
            </td>
          </tr>
        ...
        <tbody>
          <tr>
            <td>
              ...
              &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&lt;/data:AuthorizationHeader&gt;
              <br />
              &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&lt;data1:PostalOrderEventsForMailInput Barcode=&quot;14102192069353&quot;
              Language=&quot;ENG&quot;/&gt;
              <br />
              &nbsp; &nbsp;&nbsp; &nbsp;&lt;/oper:PostalOrderEventsForMail&gt;
              <br />
        ...
        <tbody>
          <tr>
            <td>
              ...
              EventDateTime=&quot;2015-12-11T15:04:37.000+03:00&quot; EventType=&quot;1&quot; EventName=&quot;Приём&quot; IndexTo=&quot;141021&quot;
              IndexEvent=&quot;298300&quot; SumPaymentForward=&quot;234000&quot; CountryEventCode=&quot;RU&quot; CountryToCode=&quot;RU&quot;/&gt;
              <br />
              &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&lt;PostalOrderEvent Number=&quot;96598&quot;
              EventDateTime=&quot;2015-12-12T16:49:13.000+03:00&quot; EventType=&quot;3&quot; EventName=&quot;Оплата&quot; IndexTo=&quot;141021&quot;
              IndexEvent=&quot;141021&quot; SumPaymentForward=&quot;234000&quot; CountryEventCode=&quot;RU&quot; CountryToCode=&quot;RU&quot;/&gt;
              <br />
              &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&lt;/ns6:PostalOrderEventsForMaiOutput&gt;
              <br />
